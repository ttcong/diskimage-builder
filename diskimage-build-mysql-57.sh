...
export MYSQL_VERSION="mysql-5.7"
...
disk-image-create -t raw -a amd64 -o ubuntu-amd64-xenial-mysql-57-prod-test --qemu-img-options compat=1.1 vm ubuntu cloud-init-datasources ubuntu-guest ubuntu-xenial-mysql &&

scp ubuntu-amd64-xenial-mysql-57-prod-test.raw congtt2@10.50.73.10:/home/congtt2/diskimage-builder
